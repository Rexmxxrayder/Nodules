...
public class AreaDamage3D : EntityBasic {
    [Header("Damage")]
    ...
    protected override void LoadSetup() {
        ...
        EntityMainCollider3D mainCollider = GetRootComponent<EntityMainCollider3D>();

        if (mainCollider == null) {
            mainCollider = GetRoot().AddComponent<EntityMainCollider3D>();
        }
